...
const OpeningScreen = () => {
  return (
    <ScreenLayout>
      <div className="flex justify-center items-center mx-auto text-white text-center px-10 flex-col gap-2 rounded-lg font-semibold">
        <p>
        ...
        <p>
          Step past the ordinary and into a curated world of rare imports, cult
          classics, and legendary machines sourced from around the globe. From
          precision fighters to screaming shmups, rhythm beasts to retro heroes
          — every game here has a story worth discovering.
        </p>
        <p>
        ...
        <Link to="main-screen" className="continue relative top-10 font-semibold text-2xl">
          Click to continue...
        </Link>
      </div>
    </ScreenLayout>
